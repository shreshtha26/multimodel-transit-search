...
def run_experiment(args):
    ...
    structural_rows = structural_diagnostic_comparison(
        {"raw_flux": flux, "gp_residual": original_model.residuals, "injected_gp_residual": injected_model.residuals},
        time=time,
...
def main(args=None):
    ...
    structural_rows.to_csv(metrics_dir / f"{prefix}_gp_structural_diagnostics.csv", index=False)
    ...
    print(f"GP structural diagnostics: {metrics_dir / f'{prefix}_gp_structural_diagnostics.csv'}")
